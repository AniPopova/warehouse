...
exports.NewMigration1705396858520 = void 0;
class NewMigration1705396858520 {
    constructor() {
        this.name = 'NewMigration1705396858520';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."order_type_enum" NOT NULL DEFAULT 'ORDER', "client_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
...
exports.NewMigration1705396858520 = NewMigration1705396858520;
//# sourceMappingURL=1705396858520-newMigration.js.map